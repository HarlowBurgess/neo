...
| Review, validation, authoring, spec work, facilitation, KPI settlement             | `Claude Sonnet 5` | `high`            | `neo.code-reviewer`, `neo.validator`, `neo.sre`, `neo.feature-agent`, `neo.design.thinking`, `neo.systems.thinking`, `neo.product.coach` |
| Orchestration, code generation, and deployment mechanics                           | `Claude Sonnet 5` | `medium`          | `neo.technical-engineer`, `neo.code-writer`, `neo.platform-engineer`                                                          |
